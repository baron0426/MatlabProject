...
decode_result2 = mat2cell(decode_result,decode_result_rowCnt ,ones(1,blockCnt));
decode_result2 = reshape(decode_result2, blockCntCol, blockCntRow)';
decode_pic = cellfun(@q3_2_1_IZigzagScan,decode_result2,'UniformOutput', false);
%extract hide message
recovered_msg = logical(cellfun(@q3_2_1_extract, num2cell(cell2mat(decode_pic))));
