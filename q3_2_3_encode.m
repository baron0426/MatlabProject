...
hall_gray_partition_DCT_zigzag = cellfun(@q3_2_3_DCT8andZigzagScan, hall_gray_partition, test_msg_out2, 'UniformOutput', false);
...
save('q3_2_3_jpegcodes.mat','height','width', 'DC_code','AC_code');